...
def save_fig(fig, env):
    folder    = 'plotting/plots/1histograms'
...
leg = plt.legend(loc='upper center', ncol=4, fontsize=30, bbox_to_anchor=(0.5, -.5))
# from https://stackoverflow.com/a/48296983
for legobj in leg.legendHandles:
    legobj.set_linewidth(3.0)

plt.xlabel(f'\n{env}: {suite(env)}', fontsize=40)
# plt.xlabel(env, fontsize=30)
