...
path_lists = [
    ...
    '../doublegumbelqlearning-results/results/DDPG',
    '../doublegumbelqlearning-results/results/TD3',
    '../doublegumbelqlearning-results/results/MoG-DDPG'
]

algorithms = [r'\textbf{DoubleGum (ours)}', 'DDPG', 'TD3', 'MoG-DDPG']
...
def save_fig(fig, env):
    folder    = 'plotting/plots/2learning'
