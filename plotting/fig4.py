...
path_lists = [
    # benchmark
    '../doublegumbelqlearning-results/continuous/DoubleGum0_5',
    '../doublegumbelqlearning-results/continuous/DoubleGum0_1',
    '../doublegumbelqlearning-results/continuous/DoubleGum',
    '../doublegumbelqlearning-results/continuous/DoubleGum-0_1',
    '../doublegumbelqlearning-results/continuous/DoubleGum-0_5'
]
