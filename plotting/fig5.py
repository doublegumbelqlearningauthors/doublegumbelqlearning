...
DoubleGum_paths = {
    '-0.5'         : '../doublegumbelqlearning-results/continuous/DoubleGum0_5',
    '-0.1'         : '../doublegumbelqlearning-results/continuous/DoubleGum0_1',
    '0.0 (Default)': '../doublegumbelqlearning-results/continuous/DoubleGum',
    '0.1'          : '../doublegumbelqlearning-results/continuous/DoubleGum-0_1',
    '0.5'          : '../doublegumbelqlearning-results/continuous/DoubleGum-0_5',
}
...
all_paths = {
    'DDPG (best w/wo Twin Networks)'           : DDPG_paths,
    r'\textbf{DoubleGum, variable $c$, (Ours)}': DoubleGum_paths
}
...
pretty_display = {
    r'\textbf{DoubleGum, variable $c$, (Ours)}': DoubleGum,
    'DDPG (best w/wo Twin Networks)'           : DDPG,
}
...
for algorithm in algorithms:
    plt.plot(0, 0, color=colors[algorithm], label=algorithm)
leg = plt.legend(loc='upper center', ncol=len(algorithms), fontsize=30, bbox_to_anchor=(0.5, -.25))
